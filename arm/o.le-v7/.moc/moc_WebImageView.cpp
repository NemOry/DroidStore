...
static const char qt_meta_stringdata_WebImageView[] = {
    "WebImageView\0\0urlChanged()\0bytes,total\0"
    "loadingChanged(double,double)\0"
    "imageLoaded()\0url\0setUrl(QUrl)\0"
    "clearCache()\0onImageLoaded()\0,\0"
...
void WebImageView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->loadingChanged((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        case 2: _t->imageLoaded(); break;
        case 3: _t->setUrl((*reinterpret_cast< const QUrl(*)>(_a[1]))); break;
        case 4: _t->clearCache(); break;
        case 5: _t->onImageLoaded(); break;
...
// SIGNAL 1
void WebImageView::loadingChanged(double _t1, double _t2)
{
